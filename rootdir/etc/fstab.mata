...
/dev/block/platform/soc/1da4000.ufshc/by-name/userdata  /data              f2fs   noatime,nosuid,nodev,nodiratime,fsync_mode=nobarrier,inline_xattr,inline_data,data_flush   latemount,wait,check,formattable,encryptable=footer,length=-16384,quota
